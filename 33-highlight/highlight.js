$(function(){
    var e=new Behave({
        ...
        return $('input[type="button"]').click(function(){
            ...
            e=$(".main textarea");
            ""!==e.val()&&(t.find("pre").html(e.val()),hljs.highlightBlock(t.find("pre").get(0)),$(".main").append(t));var i=t.find("i.icon-delete"),n=t.find("i.icon-clipboard");i.click(function(){t.remove()}),n.click(function(){var e=t.find("pre"),i=document.createRange();i.selectNode(e[0]),window.getSelection().addRange(i),document.execCommand("copy"),window.getSelection().removeAllRanges()})}),e});